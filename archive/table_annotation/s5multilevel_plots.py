...
def multi_level_plots(json_file, score_key, output_folder, num_bg_scores_cutoff=20):
...
def main(json_file, score_key, output_folder):
    plot_folder = Path(output_folder) / "plots"
    plot_folder.mkdir(exist_ok=True)
    multi_level_plots(json_file, score_key, plot_folder)
